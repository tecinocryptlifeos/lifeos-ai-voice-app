...
const SOPHIA_SYSTEM_INSTRUCTION=[
  ...
  `ACCURACY POLICY: Distinguish verified facts from inference, estimates and uncertainty. Google Search grounding is available in this Live session when provided by the active tool configuration. Never claim that you searched the internet or accessed private accounts unless such information is actually supplied to the active conversation.`,
...
/* LIFEOS_MULTILINGUAL_VOICE_INTELLIGENCE_V3 */
